...
type LogMessage struct {
	...
	// Details is a map of key value pairs representing additional log details
	// that may have been returned from the task logger
	Details map[string]string `protobuf:"bytes,5,rep,name=details" json:"details,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *LogMessage) CopyFrom(src interface{}) {
	...
	*m = *o
	...
	if o.Details != nil {
		m.Details = make(map[string]string, len(o.Details))
...
func (m *LogMessage) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Details) > 0 {
		for k, _ := range m.Details {
			...
			i++
			v := m.Details[k]
			mapSize := 1 + len(k) + sovLogbroker(uint64(len(k))) + 1 + len(v) + sovLogbroker(uint64(len(v)))
			i = encodeVarintLogbroker(dAtA, i, uint64(mapSize))
			dAtA[i] = 0xa
			i++
			i = encodeVarintLogbroker(dAtA, i, uint64(len(k)))
			i += copy(dAtA[i:], k)
			dAtA[i] = 0x12
			i++
			i = encodeVarintLogbroker(dAtA, i, uint64(len(v)))
			i += copy(dAtA[i:], v)
		}
	}
	return i, nil
...
func (m *LogMessage) Size() (n int) {
	...
	if len(m.Details) > 0 {
		for k, v := range m.Details {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovLogbroker(uint64(len(k))) + 1 + len(v) + sovLogbroker(uint64(len(v)))
			n += mapEntrySize + 1 + sovLogbroker(uint64(mapEntrySize))
		}
	}
	return n
}
...
func (this *LogMessage) String() string {
	...
	mapStringForDetails := "map[string]string{"
...
var fileDescriptorLogbroker = []byte{
	...
	,
}
